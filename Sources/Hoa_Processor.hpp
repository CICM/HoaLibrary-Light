...
namespace hoa
{
    ...
    public:
        ...
        inline size_t getHarmonicIndex(const size_t degree, const long order) const noexcept {
    ...
    public:
        ...
        inline void setPlanewaveElevation(const size_t index, const T elevation) noexcept {
